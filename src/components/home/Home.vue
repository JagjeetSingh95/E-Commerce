					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2" id="jaggi-testing">
    ...
    data() {
        return {
             products: [
            {
                ...
                price: '₹ 350',
                imgSrc: 'static/images/product-01.jpg'
            },
             {
                name: 'Herschel supply',
                price: '₹ 35.31',
                imgSrc: 'static/images/product-02.jpg'
            },
             {
                name: 'Only Check Trouser',
                price: '₹ 25.50',
                imgSrc: 'static/images/product-03.jpg'
            },
             {
                name: 'Classic Trench Coat',
                price: '₹ 75.00',
                imgSrc: 'static/images/product-04.jpg'
            },
             {
                name: 'Front Pocket Jumper',
                price: '₹ 34.75',
                imgSrc: 'static/images/product-05.jpg'
            },
             {
                name: 'Vintage Inspired Classic',
                price: '₹ 93.20',
                imgSrc: 'static/images/product-06.jpg'
            },
             {
                name: 'Shirt in Stretch Cotton',
                price: '₹ 52.66',
                imgSrc: 'static/images/product-07.jpg'
            },
             {
                name: 'Pieces Metallic Printed',
                price: '₹ 18.96',
                imgSrc: 'static/images/product-08.jpg'
            }
        ]
        }
